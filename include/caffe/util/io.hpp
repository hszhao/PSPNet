...
cv::Mat ReadImageToCVMat(const string& filename,
                         const int height, const int width,
                         const bool is_color, const bool is_label,
                         int* img_height=NULL, int* img_width=NULL);
cv::Mat ReadImageToCVMat(const string& filename,
                         const int height, const int width,
                         const bool is_color, const bool is_label, const bool is_rsdata = false,
                         int* img_height=NULL, int* img_width=NULL);
cv::Mat ReadImageToCVMat(const string& filename,
                         const int height, const int width,
                         const bool is_color, const bool is_label, const bool is_rsdata,
                         const bool is_modis_bin, const std::vector<int> channel_list = std::vector<int>(0),
                         int* img_height=NULL, int* img_width=NULL);
